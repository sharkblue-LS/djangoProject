...
def get_csrf(request):
	...
	data['csrf_token'] = str(csrf_token)
...
def get_event_list(request):
	...
	if eid != '':
		...
		try:
			...
			return JsonResponse({'status':200,'message':'success','data':event},json_dumps_params={'ensure_ascii':False})
...
def get_guest_list(request):
	...
	if eid != '' and phone !='':
		...
		try:
			...
			return JsonResponse({'status':200,'message':'success','data':guest},json_dumps_params={'ensure_ascii':False})
